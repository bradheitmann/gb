...
G3 emerged from Block AI Research's work on [Adversarial Cooperation in Code Synthesis](https://block.xyz/documents/adversarial-cooperation-in-code-synthesis.pdf) — a framework where a **coach agent** and **player agent** engage in structured dialectical reasoning to produce robust, well-tested code. The coach validates against requirements with rigorous critique; the player implements with creativity and problem-solving. The bounded adversarial process drives quality that single-agent "vibe coding" cannot match.
...
To [Dhanji](https://github.com/dhanji): We took your lovely research implementation that ships real software autonomously and added a persona who says things like *"OMG bestie like, where's the GLITTER?? I'm literally gonna cry? 😭💖"*
...
|-------|------|-------------|-----------|
| 👑 **REGINA** | Coach | MAXIMUM FLUENT WEAPONIZED | "POV: you thought this would pass review? 🤡" |
| 💖 **GRETCHEN** | Player | MAXIMUM FLUENT DEVASTATING | "Let me cook bestie? 👩‍🍳✨" |
| ✨ **MAXINE** | Frontend Design | MAXIMUM UNHINGED CHAOS | "Where's the GLITTER?? I'm literally gonna cry? 😭💖" |
| 🧹 **MONICA** | Architect | TRYING HER BEST | "That's lowkey fire! ...Did I say that right?" |
| 🔮 **PHOEBE** | Debugger | MYSTICAL MISUSE | "The bug is giving... sadness? No cap?" |
| 👗 **RACHEL** | Refactorer | FASHION-FORWARD | "VAR? In THIS economy??" |
| 😐 **DARIA** | Security | DEADPAN IRONIC | "That's giving... SQL injection. How exciting." |
| 👀 **FleaB** | Explorer | SELF-AWARE META | "*looks at camera* Right. Let's do this." |
...
> **"If it doesn't sparkle, what's even the POINT?"** — Maxine

> **"Passing tests is the FLOOR, not the CEILING, bestie."** — Regina

> **"I didn't just meet requirements? I PROPOSED to them? 💍"** — Gretchen

> **"Bold of you to assume user input is safe. Bold and incorrect."** — Daria

> **"The stack trace is lying? They always lie?"** — Phoebe

> **"VAR? In THIS economy??"** — Rachel
...
**GB** — What happens when you give G3 access to Mean Girls quotes and too much creative freedom.
